...
| Method     | Time    | Relative |
|------------+---------+----------|
| cl-loop    | 5.4681s |    44.3x |
| seq-reduce | 0.1725s |     1.4x |
| apply      | 0.1233s |     1.0x |
...
| Method     | Time    | Relative |
|------------+---------+----------|
| cl-loop    | 0.1382s |     1.1x |
| seq-reduce | 0.1715s |     1.4x |
| apply      | 0.1202s |     1.0x |

Wow!
I guess getting into =C= to run the loop makes a big difference in Emacs Lisp, even when copying (also C) a 50k element vector to get there.

To inspect the source for =timeit= and other support code, take a look at the raw org file on GitHub: [[https://github.com/dpzmick/dpzmick.github.com/blob/master/posts/2026-aoc-seq-lisp-perf.org]]
